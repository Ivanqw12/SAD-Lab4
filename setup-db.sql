-- ============================================================
-- RESET DATABASE FOR FACILITY RESERVATION SYSTEM (Lab 4)
-- Deletes the old/mismatched tables, then recreates the
-- exact schema.sql schema and re-adds the demo users/facilities.
